...
These memory types are implemented through ClawVault's [typed primitives](/docs/primitives/overview) — Tasks, Projects, Observations, Decisions, Handoffs, and Templates — which define how each type is stored, managed, and retrieved.
...
<div className="p-4 rounded-lg bg-red-400/10 border border-red-400/20 mb-4">
...
<div className="p-4 rounded-lg bg-blue-400/10 border border-blue-400/20 mt-4">
**Note:** Quick captures go to the `inbox/` category for later processing into proper types.
</div>
