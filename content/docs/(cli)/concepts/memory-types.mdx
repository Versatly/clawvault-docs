...
These memory types are implemented through ClawVault's [typed primitives](/primitives/overview) — Tasks, Projects, Observations, Decisions, Handoffs, and Templates — which define how each type is stored, managed, and retrieved.
