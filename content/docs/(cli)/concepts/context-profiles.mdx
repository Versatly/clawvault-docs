...
```bash
# Incident-like behavior: tighter graph expansion
clawvault context "query" --profile incident --max-hops 1

# Planning-like behavior: broader graph expansion
clawvault context "query" --profile planning --max-hops 3
```
