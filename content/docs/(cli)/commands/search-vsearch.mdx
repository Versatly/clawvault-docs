...
|------|-------------|---------|
| `-n, --limit <n>` | Max results to return | 10 |
| `-c, --category <category>` | Filter by category | All categories |
| `--tags <tags>` | Filter by tags (comma-separated) | — |
| `--recent` | Boost recent documents | false |
| `--full` | Include full content in results | false |
...
| Flag | Description | Default |
|------|-------------|---------|
| `-n, --limit <n>` | Max results to return | 5 |
| `-c, --category <category>` | Filter by category | All categories |
| `--tags <tags>` | Filter by tags (comma-separated) | — |
| `--recent` | Boost recent documents | false |
| `--full` | Include full content in results | false |
...
# or: npm install -g github:tobi/qmd
...
# Error: qmd not found. Install with: bun install -g github:tobi/qmd
