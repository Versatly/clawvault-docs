...
|------|-------------|---------|
| `--all` | Link all files in vault | false |
| `--backlinks <file>` | Show backlinks to a file | — |
| `--dry-run` | Show what would be linked without changing files | false |
| `--orphans` | List broken wiki-links | false |
| `--rebuild` | Rebuild backlinks index | false |
