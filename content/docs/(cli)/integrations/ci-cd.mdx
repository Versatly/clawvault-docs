...
`doctor` checks vault structure, hook installation, qmd availability, and graph index health. It returns a non-zero exit code when critical issues are found.
