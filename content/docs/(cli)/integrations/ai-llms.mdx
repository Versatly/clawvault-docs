...
| `planning` | Strategic context — decisions, commitments, projects |
| `incident` | Crisis-focused — recent errors, blockers, contacts |
| `handoff` | Session transition — recent handoffs, next steps, blockers |
| `auto` | Automatic profile detection based on query keywords |
