...
Current release documented here: **v2.5.1**.
...
### qmd (Required)
ClawVault uses [qmd](https://github.com/tobi/qmd) for local semantic search. Install it globally:
...
# Register the OpenClaw hook from the installed package
