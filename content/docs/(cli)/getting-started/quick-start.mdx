---
title: "Quick Start"
description: "Learn the essential ClawVault workflow: wake, work, capture, sleep. Master session continuity in minutes."
---
...
<div className="p-4 rounded-lg bg-memory-gold/10 border border-memory-gold/20 mb-6">
**Prerequisites:** Make sure you've completed the [Installation](./installation) and have a vault initialized.
</div>
...
- **[OpenClaw Integration](/integrations/openclaw/hook-setup)** - Automatic session management
