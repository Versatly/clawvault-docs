...
3. **qmd** (optional) -- provides BM25 and vector search. Without it, ClawVault's search commands (`search`, `vsearch`) will not work, but all other features function normally. Install via `npm install -g github:tobi/qmd`.
