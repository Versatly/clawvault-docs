...
The [memory type taxonomy](/docs/concepts/memory-types) provides eight types based on Benthic's classification: fact, feeling, decision, lesson, commitment, preference, relationship, and project.
...
See [Vault Structure](/docs/advanced/vault-structure) for details on the graph index format.
...
4. **OpenClaw Hook** (optional) -- automatic integration with the OpenClaw agent framework. Provides context death detection on startup, auto-checkpoint before `/new`, and memory injection on session start. See [Hook Setup](/docs/openclaw/hook-setup).
...
- [Installation](/docs/getting-started/installation) -- install ClawVault and qmd
- [Quick Start](/docs/getting-started/quick-start) -- hands-on walkthrough
- [Hook Setup](/docs/openclaw/hook-setup) -- automatic OpenClaw integration
- [Vault Structure](/docs/advanced/vault-structure) -- understand the file layout
- [Environment Variables](/docs/advanced/environment-variables) -- configuration reference
